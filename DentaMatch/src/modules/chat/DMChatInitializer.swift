...
class DMChatInitializer {
    ...
    class func initialize(chatList: ChatListModel, delegate: ChatTapNotificationDelegate, fetchFromBegin: Bool, moduleOutput: DMChatModuleOutput) -> UIViewController? {
