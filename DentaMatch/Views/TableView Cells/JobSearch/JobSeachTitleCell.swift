...
class JobSeachTitleCell: UITableViewCell {
    ...
    func setUp() {
        viewJobSearchTitle.layer.borderColor = Constants.Color.jobSearchTitleLocationColor.cgColor
    ...
    func updateJobTitle(){
        ...
        for objTitle in jobTitles {
            ...
            label.font = font
            label.textColor = Constants.Color.jobTitleLabelColor
            label.text = objTitle.jobTitle as String
            label.layer.borderWidth  = 1
            label.layer.borderColor = Constants.Color.jobTitleLabelColor.cgColor
